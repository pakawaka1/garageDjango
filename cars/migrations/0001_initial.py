    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VIN', models.CharField(error_messages={b'blank': b'Enter a VIN.', b'invalid': b'Enter a valid VIN.'}, max_length=17, unique=True, validators=[django.core.validators.RegexValidator(code=b'invalid_VIN', message=b'VIN must be alphanumeric.', regex=b'^[a-zA-Z0-9]*$')])),
